...
class RecordsProdModule extends AbstractModule {
 ...
 */
class RecordsDevModule extends AbstractModule {
 ...
 */
// $COVERAGE-OFF$ Can't test the production binding in Test mode
class RecordsApplicationLoader extends GuiceApplicationLoader() {
  ...
  override def builder(context: ApplicationLoader.Context): GuiceApplicationBuilder = {
    ...
    context.environment.mode match {
      case Mode.Prod =>
        // start mode
        builder.bindings(new RecordsProdModule)
      case _ =>
        // run mode
        builder.bindings(new RecordsDevModule)
    }
  }
